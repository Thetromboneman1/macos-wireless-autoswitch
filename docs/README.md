...
| Area | Document |
|---|---|
| Prior benchmark implementation | `docs/autonomous-modernization/19-hermes-mlx-implementation.md` |
| Unified architecture | `docs/autonomous-modernization/16-unified-ai-platform-architecture.md` |
| Platform config wiring | `docs/autonomous-modernization/18-platform-config-wiring.md` |
| Local AI star sweep | `docs/local-ai-star-sweep-2026-06-22/README.md` |

## Superseded Guidance

Older autonomous-modernization reports before `16-unified-ai-platform-architecture.md` are retained as implementation history. For current operations, prefer the documents listed in `Current`.
